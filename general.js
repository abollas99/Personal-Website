...
function purchaseClicked() {
    const total_price = document.getElementsByClassName('cart-total-price')[0].innerText;
    alert('Thank you for your purchase of ' + total_price)
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
        ...
        <span class="prices cart-column">${price}</span>
        <div class="quantities cart-column">
